    ...
    <el-table v-loading="loading" :data="spotsList" highlight-current-row style="width: 100%;">
      ...
      <el-table-column prop="fmUrl" align="center" label="景区封面" >
        <template slot-scope="scope">
           <img :src="`http://localhost:80/upload/spots/${scope.row.fmUrl}`"    width="100" height="100" class="head_pic"/>
        </template>
      </el-table-column>
          ...
          <el-col :span="24">
            <el-form-item label="景区封面图" prop="fmUrl">
              <el-upload
                ...
                action="http://localhost:80/spots/file/uploadFile"
                :show-file-list="false"
                :headers="headers"
                :on-success="handleAvatarSuccess"
                :before-upload="beforeAvatarUpload"
              >
                <img style="width:100px;height: 100px"  v-if="form.fmUrl"  :src="`http://localhost:80/upload/spots/${form.fmUrl}`"  class="avatar">
